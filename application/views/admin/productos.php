<main>
				...
				<table class="bordered responsive">
					...
					<tr v-for="(producto,index) in productos" v-show="(pag - 1) * NUM_RESULTS <= index  && pag * NUM_RESULTS > index">
		...
		<div id="modal2" class="modal modal-fixed-footer">
			<div class="modal-content">
					<div>
						...
						<div class="input-field">
							<input id="productoDescripcion" type="text" v-model="productoDescripcion">
							<label for="productoDescripcion">Descripcion</label>
						</div>
						...
						<!-- <label>File
							<input type="file" id="file" ref="file" accept="image/*" v-on:change="onChangeFileUpload()"/>
						</label>
			 -->
